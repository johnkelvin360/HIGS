// auto_fitter_with_ref.C  (fixed and extended)
// NOTE: function name auto_fitter_with_ref(int runNumber = 26) preserved exactly.
...
void auto_fitter_with_ref(int runNumber = 26) {
